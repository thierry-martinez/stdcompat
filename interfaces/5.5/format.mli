...
val lfprintf :
  formatter -> ('a, formatter, unit) format -> ('a, unit) Args.t -> unit
val lprintf : ('a, formatter, unit) format -> ('a, unit) Args.t -> unit
val leprintf : ('a, formatter, unit) format -> ('a, unit) Args.t -> unit
val lasprintf :
  ('a, formatter, unit, string) format4 -> ('a, string) Args.t -> string
val ldprintf :
