...
sig
  ...
  functor (H : SeededHashedType) ->
    sig
      type key = H.t
      and 'a t = 'a Stdcompat__hashtbl_ext.MakeSeeded(H).t
      val create : ?random:bool -> int -> 'a t
      val clear : 'a t -> unit
      val reset : 'a t -> unit
      val copy : 'a t -> 'a t
...
*)
(** @since 4.07.0: module Hashtbl = MoreLabels.Hashtbl
 *)
...
*)
(** @since 4.07.0: module Map = MoreLabels.Map
 *)
...
(** @since 4.08.0: module Set = MoreLabels.Set
 *)
